                        ...
                        <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <table class="table table-stripped table-bordered" data-placeholder='true' id="service_list">
                                            ...
                                            <tbody>
                                                <?php
                                                // Services query with prepared statement
                                                $services = $conn->prepare("SELECT rs.*, s.service
                                                                            FROM `repair_services` rs
                                                                            INNER JOIN service_list s ON rs.service_id = s.id
                                                                            WHERE rs.repair_id = ?");
                                                $services->bind_param("i", $id); // 'i' for integer type
                                                $services->execute();
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <table class="table table-stripped table-bordered" data-placeholder='true' id="material_list">
                                            ...
                                            <tbody>
                                                <?php
                                                // Materials query with prepared statement
                                                $materials = $conn->prepare("SELECT * FROM `repair_materials` WHERE repair_id = ?");
                                                $materials->bind_param("i", $id); // 'i' for integer type
                                                $materials->execute();
                                                $materials_result = $materials->get_result();
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <?php else: ?>
                                        <span class="rounded-pill badge badge-dark bg-gradient-dark ml-4">Unpaid</span>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group col-md-4">
